...
<CookbookCase 
  ...
  inputAssets={[{ type: 'image', url: 'https://cdn.weniai.com/seedance/2-1-1.png' }]}
...
<CookbookCase 
  ...
  inputAssets={[{ type: 'video', url: 'https://cdn.weniai.com/seedance/2-2-1.mp4' }]}
...
<CookbookCase 
  ...
  inputAssets={[{ type: 'video', url: 'https://cdn.weniai.com/seedance/2-3-1.mp4' }]}
...
<CookbookCase 
  ...
  inputAssets={[{ type: 'image', url: 'https://cdn.weniai.com/seedance/2-4-1.png' }]}
