...
<CookbookCase 
  ...
  inputAssets={[{ type: 'video', url: 'https://github.com/leason-wan/awesome-seedance-2.0/releases/download/assets-1/2-2-1.mp4' }]}
...
<CookbookCase 
  ...
  inputAssets={[{ type: 'video', url: 'https://github.com/leason-wan/awesome-seedance-2.0/releases/download/assets-1/2-3-1.mp4' }]}
