...
title: 多模态进化
description: 了解 Seedance 2.0 如何将文本、图片、视频和音频组合成灵活的多模态创作流程。
keywords: 多模态创作, 文本 图片 视频 音频, Seedance 2.0 工作流
lang: zh
...
<CookbookCase 
  client:load
  title="Case 4"
  prompt={`0-2秒画面：快速四格闪切，红、粉、紫、豹纹四款蝴蝶结依次定格，特写缎面光泽与 “chéri” 品牌字样。画外音“Chéri 자석 리본으로 무궁무진한 아름다움을 연출해 보세요!”  
